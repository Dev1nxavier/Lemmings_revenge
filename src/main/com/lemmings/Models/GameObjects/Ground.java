 ...
 *       This object has special properties that allow a Character to appear on
 *       top of it
 *       or walk in front of it. It also can be removed by a Character with
 *       certain skill actions
...
public class Ground extends GameObject {
     ...
     * @param rowAndCol the 2D array address of this object in the LevelModel's map
     *                  array.
     */
    public Ground(int x, int y, int width, int height, Point rowAndCol) {
        super(x, y, width, height, rowAndCol);
        setImage("ground_tiles.png");
